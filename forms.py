...
class VenueForm(FlaskForm):
    ...
    generes = SelectMultipleField(
        'generes', validators=[DataRequired()],
        choices= ( 
    ...
    seek_description = StringField('seek_description')
...
class ArtistForm(FlaskForm):
    ...
    phone = StringField('phone', validators=[DataRequired()])
    image_link = StringField('image_link')
    generes = SelectMultipleField('generes', validators=[DataRequired()],
        choices=[
            ('Alternative', 'Alternative'),
            ('Blues', 'Blues'),
            ('Classical', 'Classical'),
    ...
    seek_description = StringField('seek_description', validators=[DataRequired()])

    # Tod implement new artist form and new show form
